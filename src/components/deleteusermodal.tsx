        ...
        <>
            {
                ...
                ? <div className="w-full h-[100vh] fixed left-0 top-0 z-40 flex flex-col justify-start items-center pt-[12vh] tlg:pt-[10vh] tmd:pt-[60px] backdrop-blur bg-blur-theme dark:border-theme-4">
                    <div ref={refSearchOutside} className="overflow-hidden w-[400px] tmd:w-[calc(100%-24px)] rounded-[12px] border border-theme-7 dark:border-theme-3 bg-theme-9 dark:bg-theme-2 animate-zoom-in">
                        ...
                        <div className="w-full p-[20px] bg-theme-8 dark:bg-theme-blue-2">
                            <h2 className="font-bold text-[16px] text-theme-4 dark:text-theme-9 mb-[8px]">회원 탈퇴 시 유의사항</h2>
                            <div className='w-full flex flex-row justify-start items-start mb-[4px] text-[12px] text-theme-5 dark:text-theme-7'>
                            ...
                            <div className='w-full flex flex-row justify-start items-start text-[12px] text-theme-5 dark:text-theme-7'>
                                <svg className='w-[12px] mt-[3px] mr-[6px] fill-theme-red' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
                                <div>재가입 시에도 삭제된 정보는 복구되지 않습니다.</div>
                            </div>
                            <div className="w-full h-px bg-theme-5 mt-[16px]"></div>
                            ...
                            <input onChange={handleDeleteValChange} id="delete-confirm" type="text" placeholder={`${user.user_id}/탈퇴한다`} className={`${inputChk === '' ? 'border-theme-4 focus:border-theme-yellow dark:border-theme-5 focus:dark:border-theme-blue-1' : 'border-theme-red focus:border-theme-red dark:border-theme-red focus:dark:border-theme-red'} w-full text-[14px] text-theme-10 dark:text-theme-9 px-[14px] py-[8px] mt-[6px] rounded-[8px] border-[2px] placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 dark:bg-theme-blue-2 autofill:bg-theme-4 autofill:dark:bg-theme-blue-2`}/>
                            {
                                inputChk === 'empty'
                            ...
                            <button onClick={handleDeleteBtnClick} className='w-full h-[40px] mt-[10px] rounded-[8px] flex flex-row justify-center items-center text-[14px] font-medium text-theme-10 dark:text-theme-9 bg-theme-red/80 hover:bg-theme-red tlg:hover:bg-theme-red/80'>
                                {
                                    isLoading === true
