...
export default function FontBox ({lang, type, sort, user, like, filter, searchword, text, num}:{lang: string, type: string, sort: string, user: any, like: any, filter: string, searchword: string, text: string, num: number}) {        
    ...
    return (
        <>
            <div className='w-[100%] relative flex flex-col justify-start items-start'>
                <div>
                    {
                        data && data.pages[0].total
                        ? <div className='absolute right-[8px] top-[-72px] text-[14px] flex items-center text-theme-5 dark:text-theme-7'>
                            <svg className='w-[12px] fill-theme-5 dark:fill-theme-7 mr-[4px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M181.3 32.4c17.4 2.9 29.2 19.4 26.3 36.8L197.8 128h95.1l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3s29.2 19.4 26.3 36.8L357.8 128H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H347.1L325.8 320H384c17.7 0 32 14.3 32 32s-14.3 32-32 32H315.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8l9.8-58.7H155.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8L90.2 384H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l21.3-128H64c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3zM187.1 192L165.8 320h95.1l21.3-128H187.1z"/></svg>
                            {data.pages[0].total} of 358
                        </div> : <></>
                    }
                </div>
                <div className="main-menu w-[100%] relative flex flex-wrap flex-row justify-between items-stretch pt-[20px] pb-[20px]">
