                                ...
                                ? ( data.fonts.length !== 0
                                    ? <div className="w-[100%] px-[24px] tmd:px-[16px]">
                                        ...
                                        {data && data.fonts.map((font: {
                                            ...
                                            return (
                                                <Link href={`/DetailPage/${font.code}`} key={font.code} className="search-link w-[100%] h-[60px] tmd:h-[48px] relative px-[16px] mt-[8px] flex flex-row justify-start items-center rounded-[8px] bg-dark-theme-3/80 group hover:bg-dark-theme-4">
