export default function SkeletonBox() {
    return (
        <>
            <div className='skeleton-box w-[calc(20%-8px)] tlg:w-[calc(33.3%-6px)] tmd:w-[calc(50%-4px)] txs:w-full h-[18vw] tlg:h-[30vw] tmd:h-[46vw] txs:h-[82vw] p-[1.04vw] tlg:p-[1.95vw] tmd:p-[2.6vw] txs:p-[4.17vw] mt-3 tlg:mt-2.5 rounded-lg border border-theme-7 dark:border-theme-5'>
                ...
                <div className='skeleton-gradient w-full h-[8.33vw] tlg:h-[15.63vw] tmd:h-[20.83vw] txs:h-[33.33vw] rounded-lg bg-theme-3'></div>
            </div>
        </>
    )
}