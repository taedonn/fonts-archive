export default function TooltipIndex() {
    ...
    return (
        <>
            <div className="fixed z-20 right-4 bottom-4 flex flex-col justify-start items-start">
                <div onClick={goUp} className="w-10 h-10 rounded-full relative flex flex-row justify-center items-center mt-2 tlg:mt-1.5 cursor-pointer bg-theme-4 dark:bg-theme-1 drop-default-tooltip">
