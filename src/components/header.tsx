                        ...
                        </Link>
                        {
                            ...
                            ? <>
                                <div className="tlg:w-[calc(100%-56px)] relative group">
                                    <input onChange={handleTextChange} type='text' placeholder='원하는 문구를 적어보세요...' className="w-[280px] txl:w-[200px] tlg:w-[100%] text-[14px] txl:text-[12px] text-normal placeholder-theme-5 dark:placeholder-theme-6 text-theme-5 dark:text-theme-8 leading-none border rounded-full border-theme-7 dark:border-theme-4 px-[20px] txl:px-[16px] py-[10px] txl:py-[8px] pl-[52px] txl:pl-[38px] bg-transparent group-hover:dark:bg-theme-3/40 tlg:group-hover:bg-transparent focus:dark:bg-theme-3/40 tlg:focus:bg-transparent"/>
                    ...
                    <div className='w-content flex flex-row justify-start items-center'>
                        {
                            ...
                            ? <>
                                ...
                                <div className='w-content relative flex flex-row justify-start items-center'>
                                        ...
                                        <div ref={refLicenseOption} id="option-license" className='option w-[128px] txl:w-[104px] absolute z-2 left-[50%] top-[40px] txl:top-[36px] translate-x-[-50%] border border-theme-yellow dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] txl:px-[14px] py-[20px] txl:py-[16px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                <label htmlFor='option-license-all'>
                                                    <svg className='w-[18px] txl:w-[14px] mr-[10px] txl:mr-[8px] cursor-pointer fill-theme-yellow dark:fill-theme-blue-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/><path d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.235.235 0 0 1 .02-.022z"/></svg>
                                                    <svg className='w-[18px] txl:w-[14px] mr-[10px] txl:mr-[8px] cursor-pointer fill-theme-yellow dark:fill-theme-blue-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/></svg>
                                                </label>
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">전체</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">인쇄물</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">웹 서비스</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">영상물</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">포장지</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">임베딩</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[12px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">BI/CI</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">OFL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='w-content relative flex flex-row justify-start items-center ml-[8px] txl:ml-[4px]'>
                                        ...
                                        <div ref={refLangOption} id="option-lang" className='option w-[128px] txl:w-[104px] absolute z-2 left-[50%] top-[40px] txl:top-[36px] translate-x-[-50%] border border-theme-yellow dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] txl:px-[14px] py-[20px] txl:py-[16px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">한국어</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] text-theme-10 dark:text-theme-9 leading-tight txl:pb-px">영어</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='w-content relative flex flex-row justify-start items-center ml-[8px] txl:ml-[4px]'>
                                        ...
                                        <div ref={refTypeOption} id="option-type" className='option w-[128px] txl:w-[104px] absolute z-2 left-[50%] top-[40px] txl:top-[36px] translate-x-[-50%] border border-theme-yellow dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] txl:px-[14px] py-[20px] txl:py-[16px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">전체</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">고딕</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">명조</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">손글씨</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">장식체</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">픽셀체</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='w-content relative flex flex-row justify-start items-center ml-[8px] txl:ml-[4px]'>
                                        ...
                                        <div ref={refSortOption} id="option-sort" className='option w-[114px] txl:w-[100px] absolute z-2 left-[50%] top-[40px] txl:top-[36px] translate-x-[-50%] border border-theme-yellow dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] txl:px-[14px] py-[22px] txl:py-[16px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">조회순</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">인기순</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center mb-[16px] txl:mb-[10px]'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">최신순</span>
                                            </div>
                                            ...
                                            <div className='flex flex-row justify-start items-center'>
                                                ...
                                                <span className="text-[14px] txl:text-[12px] txl:pb-px text-theme-10 dark:text-theme-9 leading-tight">이름순</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="group w-content relative tlg:hidden">
                                    <input onChange={handleSearch} type="text" placeholder="폰트, 회사명을 검색해 보세요..." defaultValue={source} className="w-[280px] txl:w-[200px] tlg:w-[100%] text-[14px] txl:text-[12px] text-normal placeholder-theme-5 dark:placeholder-theme-6 text-theme-5 dark:text-theme-8 leading-none border rounded-full border-theme-7 dark:border-theme-4 px-[20px] txl:px-[16px] py-[10px] txl:py-[8px] pl-[52px] txl:pl-[38px] bg-transparent group-hover:dark:bg-theme-3/40 tlg:group-hover:bg-transparent focus:dark:bg-theme-3/40 tlg:focus:bg-transparent"/>
                        ...
                        <div className="relative mx-[10px] txl:mx-[8px]">
                            ...
                            <label ref={refThemeLabel} htmlFor="color-theme" className="w-[32px] h-[32px] flex flex-row justify-center items-center cursor-pointer">
                                <svg style={thisTheme === "light" ? {display: "block"} : {display: "none"}} className={`light-mode w-[20px] ${thisTheme === "light" ? `fill-theme-4` : `fill-theme-9/80`}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/></svg>
                            ...
                            <div ref={refThemeDiv} id="color-theme-select" className="color-theme-select w-[128px] absolute left-[50%] top-[40px] translate-x-[-50%] rounded-[8px] px-[16px] py-[8px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark">
                            ...
                            <label ref={refAccountLabel} htmlFor="account" className="w-[32px] h-[32px] flex flex-row justify-center items-center cursor-pointer">
                                {
                                    ...
                                    : <img className="w-[28px] h-[28px] object-cover rounded-full" src={user.image} width={28} height={28} alt="유저 프로필 사진" referrerPolicy="no-referrer"/>
                                }
                            </label>
                            <div ref={refAccountDiv} id="account-select" className="account-select w-[136px] absolute right-[0] top-[40px] rounded-[8px] px-[16px] py-[12px] bg-theme-3 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark cursor-default">
                                ...
                                </Link>
                                {
                                    ...
                                    ? <>
                                        ...
                                        <Link href="/user/comments" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-px group">
                                        ...
                                        </Link>
                                        {
                                            ...
                                            ? <>
                                                ...
                                                <Link href="/admin/font/add" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-px group">
                                                    <svg className="w-[14px] mr-[4px] mb-px fill-theme-8/80 group-hover:fill-theme-10/80 tlg:group-hover:fill-theme-8/80 dark:fill-theme-7/80 group-hover:dark:fill-theme-9/80 tlg:group-hover:dark:fill-theme-7/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="m2.244 13.081.943-2.803H6.66l.944 2.803H8.86L5.54 3.75H4.322L1 13.081h1.244zm2.7-7.923L6.34 9.314H3.51l1.4-4.156h.034zm9.146 7.027h.035v.896h1.128V8.125c0-1.51-1.114-2.345-2.646-2.345-1.736 0-2.59.916-2.666 2.174h1.108c.068-.718.595-1.19 1.517-1.19.971 0 1.518.52 1.518 1.464v.731H12.19c-1.647.007-2.522.8-2.522 2.058 0 1.319.957 2.18 2.345 2.18 1.06 0 1.716-.43 2.078-1.011zm-1.763.035c-.752 0-1.456-.397-1.456-1.244 0-.65.424-1.115 1.408-1.115h1.805v.834c0 .896-.752 1.525-1.757 1.525z"/></svg>
                                                    폰트 추가
                                                </Link>
                                                <Link href="/admin/font/edit" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-px group">
                                                    <svg className="w-[14px] mr-[4px] mb-px fill-theme-8/80 group-hover:fill-theme-10/80 tlg:group-hover:fill-theme-8/80 dark:fill-theme-7/80 group-hover:dark:fill-theme-9/80 tlg:group-hover:dark:fill-theme-7/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="m2.244 13.081.943-2.803H6.66l.944 2.803H8.86L5.54 3.75H4.322L1 13.081h1.244zm2.7-7.923L6.34 9.314H3.51l1.4-4.156h.034zm9.146 7.027h.035v.896h1.128V8.125c0-1.51-1.114-2.345-2.646-2.345-1.736 0-2.59.916-2.666 2.174h1.108c.068-.718.595-1.19 1.517-1.19.971 0 1.518.52 1.518 1.464v.731H12.19c-1.647.007-2.522.8-2.522 2.058 0 1.319.957 2.18 2.345 2.18 1.06 0 1.716-.43 2.078-1.011zm-1.763.035c-.752 0-1.456-.397-1.456-1.244 0-.65.424-1.115 1.408-1.115h1.805v.834c0 .896-.752 1.525-1.757 1.525z"/></svg>
                                                    폰트 수정
                                                </Link>
                                                ...
                                                <Link href="/admin/bug/list" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-[2px] group">
                                                    <svg className="w-[12px] mr-[6px] mb-px fill-theme-8/80 group-hover:fill-theme-10/80 tlg:group-hover:fill-theme-8/80 dark:fill-theme-7/80 group-hover:dark:fill-theme-9/80 tlg:group-hover:dark:fill-theme-7/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M16.1 260.2c-22.6 12.9-20.5 47.3 3.6 57.3L160 376V479.3c0 18.1 14.6 32.7 32.7 32.7c9.7 0 18.9-4.3 25.1-11.8l62-74.3 123.9 51.6c18.9 7.9 40.8-4.5 43.9-24.7l64-416c1.9-12.1-3.4-24.3-13.5-31.2s-23.3-7.5-34-1.4l-448 256zm52.1 25.5L409.7 90.6 190.1 336l1.2 1L68.2 285.7zM403.3 425.4L236.7 355.9 450.8 116.6 403.3 425.4z"/></svg>
                                                    버그 제보
                                                </Link>
                                                <Link href="/admin/notices/add" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-[2px] group">
