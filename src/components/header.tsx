                                    ...
                                    ? <>
                                        ...
                                        </a>
                                        {
                                            ...
                                            ? <>
                                                ...
                                                {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
                                                <a href="/font/edit" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[2px] ml-px group">
