...
export default function Header (
    ...
    const handleLogOut = async () => {
        await axios.get('/api/user/logout').then(() => location.reload());
    }

    return (
        <>
            <div className="w-[100%] mt-[60px] tlg:mt-[52px]">
                <div className='interface w-[100%] h-[60px] tlg:h-[52px] px-[20px] tlg:px-[16px] fixed right-0 top-0 z-10 flex flex-row justify-between items-center backdrop-blur bg-theme-9/80 dark:bg-theme-2/80 border-b border-theme-7 dark:border-theme-4'>
                    ...
                    <div className='w-content flex flex-row justify-start items-center'>
                        ...
                        <div className="relative flex flex-row justify-center items-center cursor-pointer">
                            ...
                            <label ref={refAccountLabel} htmlFor="account" className="w-[32px] h-[32px] flex flex-row justify-center items-center cursor-pointer">
                                <svg className="w-[22px] fill-theme-5/80 hover:fill-theme-5 tlg:hover:fill-theme-4/80 dark:fill-theme-9/80 hover:dark:fill-theme-9 tlg:hover:dark:fill-theme-9/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/><path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/></svg>
                            </label>
                            <div ref={refAccountDiv} id="account-select" className="account-select w-[128px] absolute right-[0] top-[40px] rounded-[8px] px-[16px] py-[12px] bg-theme-5 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark cursor-default">
                                ...
                                </Link>
                                {
                                    ...
                                    ? <>
                                        ...
                                        <div className="w-[100%] h-px bg-theme-8/80 dark:bg-theme-7/80 mt-[10px] mb-[10px]"></div>
                                        <div>{user.user_name}<span className="text-theme-8/80 dark:text-theme-7/80"> 님,</span></div>
                                        <a href="/user/info" className="block text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-[6px]">회원정보수정</a>
                                        {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
                                        <button onClick={handleLogOut} className="w-[100%] h-[28px] flex flex-row justify-center items-center rounded-[8px] mt-[10px] bg-theme-yellow/90 hover:bg-theme-yellow tlg:hover:bg-theme-yellow/90 dark:bg-theme-blue-1/90 hover:dark:bg-theme-blue-1 tlg:hover:dark:bg-theme-blue-1/90">
                                            <span className="text-theme-5 dark:text-theme-blue-2 font-medium mt-px">로그아웃</span>
                                        </button>
                                    </div>
                                }
                            </div>
