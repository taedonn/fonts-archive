                        ...
                        <div className="relative flex flex-row justify-center items-center cursor-pointer">
                            ...
                            <div ref={refAccountDiv} id="account-select" className="account-select w-[136px] absolute right-[0] top-[40px] rounded-[8px] px-[16px] py-[12px] bg-theme-4 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark cursor-default">
                                <Link href="https://github.com/fonts-archive" target="_blank" className="group flex flex-row justify-start items-center">
                                    ...
                                    <span className="text-[13px] ml-[6px] text-theme-10/80 group-hover:text-theme-10 tlg:group-hover:text-theme-10/80 dark:text-theme-9/80 group-hover:dark:text-theme-9 tlg:group-hover:dark:text-theme-9/80">깃헙 프로젝트</span>
                                </Link>
                                <Link href="https://github.com/orgs/fonts-archive/discussions/categories/%ED%8F%B0%ED%8A%B8-%EC%A0%9C%EB%B3%B4%ED%95%98%EA%B8%B0" target="_blank" className="group flex flex-row justify-start items-center mt-[5px]">
                                ...
                                <Link href="https://github.com/orgs/fonts-archive/discussions/categories/%EB%B2%84%EA%B7%B8-%EB%A6%AC%ED%8F%AC%ED%8A%B8" target="_blank" className="group flex flex-row justify-start items-center mt-[5px]">
                                ...
                                </Link>
                                {
                                    ...
                                    ? <>
                                        {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
                                        <a href="/user/login" className="w-[100%] h-[28px] flex flex-row justify-center items-center rounded-[8px] mt-[12px] bg-theme-yellow/90 hover:bg-theme-yellow tlg:hover:bg-theme-yellow/90 dark:bg-theme-blue-1/90 hover:dark:bg-theme-blue-1 tlg:hover:dark:bg-theme-blue-1/90">
                                        ...
                                        <a href="/?filter=liked" className="flex flex-row justify-start items-center text-theme-8/80 hover:text-theme-10/80 tlg:hover:text-theme-8/80 dark:text-theme-7/80 hover:dark:text-theme-9/80 tlg:hover:dark:text-theme-7/80 mt-px ml-px group">
                                            <svg className="w-[13px] mr-[5px] mb-px fill-theme-yellow dark:fill-theme-yellow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/></svg>
                                            좋아요 보기
                                        </a>
                                        {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
