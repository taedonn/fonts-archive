...
export default function ToTop() {
  ...
  return (
    <div
      ...
      className="w-10 h-10 group fixed z-10 right-0 bottom-4 flex flex-col justify-start items-start"
    >
      <div
        ref={button}
        onClick={goUp}
        className="invisible opacity-0 w-full h-full rounded-full absolute right-0 bottom-0 flex flex-row justify-center items-center mt-2 tlg:mt-1.5 duration-200 cursor-pointer bg-h-e dark:bg-f-8 group-hover:bg-h-1 group-hover:dark:bg-f-9 drop-default-tooltip"
      >
