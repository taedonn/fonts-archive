...
export default function Tooltip() {
    ...
    return (
        <>
            <div ref={tooltip} onMouseDown={e => onMouseDown(e, 0.9)} onMouseUp={onMouseUp} onMouseOut={onMouseOut} className="w-10 h-10 group fixed z-10 right-0 bottom-4 flex flex-col justify-start items-start">
