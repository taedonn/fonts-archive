        ...
        <>
            <div className='side_menu' onMouseOver={sideOnMouseOver} onMouseOut={sideOnMouseOut}>
                <div className='side_menu_scroll'>
                    ...
                    <Link className='title' to={'/fonts-archive'} onClick={listOnClick}>
                    ...
                    <div className='search_bar'>
                        <input type='text' placeholder='폰트 검색하기' onChange={searchChange}/>
                    ...
                    <div className='font_list'>
                        {
                            data.map((dataEach) => 
                                <Link className="font_name" onClick={listOnClick} to={`/fonts-archive/DetailPage/${dataEach.c[0].v}`} key={dataEach.c[0].v}>{dataEach.c[1].v}</Link>
                            )
                        }
                    </div>
                </div>
