                ...
                <div className='w-[360px] flex flex-col justify-center items-start mt-[100px] tlg:mt-[40px]'>
                    ...
                    <div className='w-[100%] p-[20px] rounded-[8px] text-theme-10 dark:text-theme-9 bg-theme-5 dark:bg-theme-3 drop-shadow-default dark:drop-shadow-dark'>
                        ...
                        </div>
                        {
                            ...
                            : ( nameChk === 'exists'
                                ? <span className='block text-[12px] text-theme-red mt-[4px] ml-[16px]'>이름이 이미 사용중입니다.</span>
                                : <></>
                            )
                        }
                        ...
                        <label htmlFor='pw' className='block text-[14px] mt-[18px] ml-px'>비밀번호</label>
                        <div className='w-[100%] flex flex-row justify-between items-center mt-[6px]'>
                            ...
                            <button onClick={handlePwClick} className='w-[76px] h-[39px] pt-px rounded-[8px] font-medium text-[14px] text-theme-5 dark:text-theme-blue-2 bg-theme-yellow/80 hover:bg-theme-yellow tlg:hover:bg-theme-yellow/80 dark:bg-theme-blue-1/80 hover:dark:bg-theme-blue-1 tlg:hover:dark:bg-theme-blue-1/80'>변경하기</button>
                        </div>
                        <div className='w-[100%] h-px bg-theme-6 dark:bg-theme-5 mt-[18px] mb-[36px]'></div>
                        <div className='w-[100%] flex flex-row justify-start items-start mb-[4px] text-[12px] text-theme-8 dark:text-theme-7'>
                            <svg className='w-[12px] mt-[3px] mr-[6px] fill-theme-red/80' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
                        ...
                        <button className='w-[100%] h-[40px] rounded-[8px] flex flex-row justify-center items-center text-[14px] font-medium text-theme-10 dark:text-theme-9 bg-theme-red/80 hover:bg-theme-red tlg:hover:bg-theme-red/80'>회원 탈퇴하기</button>
                    </div>
                </div>
            </div>
        </>
