...
// api
import { FetchComments, FetchCommentsLength } from "../api/user/fetchcomments";
...
const Comments = ({ params }: any) => {
  const { theme, userAgent, user, page, filter, search, count, comments } =
    params;
