                    ...
                    <div className='w-[22.5rem] flex flex-col justify-center my-16 lg:my-24 mt-8 lg:mt-16 text-l-2 dark:text-white'>
                        ...
                        <div className='w-full h-14 text-sm rounded-lg mb-2.5 gap-2 flex justify-center items-center border border-l-b dark:border-d-6'>
                            <div onClick={naverLogin} onMouseDown={e => onMouseDown(e, 0.9, true)} onMouseUp={onMouseUp} onMouseOut={onMouseOut} className='w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-naver'>
                                ...
                                <div className="w-max absolute z-10 left-1/2 -top-8 px-3 py-1.5 text-[0.813rem] leading-none origin-bottom rounded hidden lg:group-hover:block lg:group-hover:animate-hover-delay bg-theme-naver text-l-2 dark:drop-shadow-dark selection:bg-transparent">네이버로 로그인</div>
                            </div>
                            <div onClick={kakaoLogin} onMouseDown={e => onMouseDown(e, 0.9, true)} onMouseUp={onMouseUp} onMouseOut={onMouseOut} className='w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-kakao'>
                                ...
                                <div className="w-max absolute z-10 left-1/2 -top-8 px-3 py-1.5 text-[0.813rem] leading-none origin-bottom rounded hidden lg:group-hover:block lg:group-hover:animate-hover-delay bg-theme-kakao text-l-2 dark:drop-shadow-dark selection:bg-transparent">카카오로 로그인</div>
                            </div>
                            <div onClick={googleLogin} onMouseDown={e => onMouseDown(e, 0.9, true)} onMouseUp={onMouseUp} onMouseOut={onMouseOut} className='w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-black dark:bg-white'>
                                ...
                                <div className="w-max absolute z-10 left-1/2 -top-8 px-3 py-1.5 text-[0.813rem] leading-none origin-bottom rounded hidden lg:group-hover:block lg:group-hover:animate-hover-delay bg-black text-white dark:bg-white dark:text-black dark:drop-shadow-dark selection:bg-transparent">구글로 로그인</div>
                            </div>
                            <div onClick={githubLogin} onMouseDown={e => onMouseDown(e, 0.9, true)} onMouseUp={onMouseUp} onMouseOut={onMouseOut} className='w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-black dark:bg-white'>
                                ...
                                <div className="w-max absolute z-10 left-1/2 -top-8 px-3 py-1.5 text-[0.813rem] leading-none origin-bottom rounded hidden lg:group-hover:block lg:group-hover:animate-hover-delay bg-black text-white dark:bg-white dark:text-black dark:drop-shadow-dark selection:bg-transparent">깃허브로 로그인</div>
                            </div>
                        </div>
