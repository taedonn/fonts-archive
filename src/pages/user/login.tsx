        ...
        <>
            ...
            <div className='w-full flex flex-col justify-center items-center'>
                <div className='w-[360px] flex flex-col justify-center items-start my-[100px] tlg:my-[40px]'>
                    ...
                    <form onSubmit={e => e.preventDefault()} className='w-full p-[20px] mb-[16px] rounded-[8px] text-theme-10 dark:text-theme-9 bg-theme-5 dark:bg-theme-3 drop-shadow-default dark:drop-shadow-dark'>
                        ...
                        <label htmlFor='pw' className='w-full flex flex-row justify-between items-center text-[14px] ml-px mt-[18px]'>
                            <span>비밀번호</span>
                    ...
                    <div className='w-full h-[52px] text-[14px] rounded-[8px] mb-[8px] gap-[8px] flex justify-center items-center border border-theme-7 dark:border-theme-4'>
                        <div onClick={naverLogin} className='w-[28px] h-[28px] rounded-[6px] group relative flex justify-center items-center cursor-pointer bg-theme-naver'>
                            ...
                            <div className="login-method login-naver w-max absolute z-10 left-[50%] top-[-36px] text-[12px] font-medium leading-none px-[12px] py-[6px] rounded-[4px] hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-naver text-theme-3">네이버로 로그인</div>
                        </div>
                        <div onClick={kakaoLogin} className='w-[28px] h-[28px] rounded-[6px] group relative flex justify-center items-center cursor-pointer bg-theme-kakao'>
                            ...
                            <div className="login-method login-kakao w-max absolute z-10 left-[50%] top-[-36px] text-[12px] font-medium leading-none px-[12px] py-[6px] rounded-[4px] hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-kakao text-theme-3">카카오로 로그인</div>
                        </div>
                        <div onClick={googleLogin} className='w-[28px] h-[28px] rounded-[6px] group relative flex justify-center items-center cursor-pointer bg-theme-10'>
                            ...
                            <div className="login-method login-google w-max absolute z-10 left-[50%] top-[-36px] text-[12px] font-medium leading-none px-[12px] py-[6px] rounded-[4px] hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-10 text-theme-3">구글로 로그인</div>
                        </div>
                        <div onClick={githubLogin} className='w-[28px] h-[28px] rounded-[6px] group relative flex justify-center items-center cursor-pointer bg-theme-1 dark:bg-theme-10'>
                            ...
                            <div className="login-method login-github w-max absolute z-10 left-[50%] top-[-36px] text-[12px] font-medium leading-none px-[12px] py-[6px] rounded-[4px] hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-1 dark:bg-theme-10 text-theme-10 dark:text-theme-3">깃허브로 로그인</div>
                        </div>
                    </div>
                    <div className='w-full h-[52px] text-[14px] rounded-[8px] flex flex-row justify-center items-center border border-theme-7 dark:border-theme-4'>
                    ...
                    <div className='w-full flex flex-row justify-center items-center text-[12px] mt-[12px]'>
