...
const Login = ({ params }: any) => {
  ...
  useEffect(() => {
    ...
    if (formPw.value !== "") {
      setPwVal(formPw.value);
    }

    // 세션 스토리지의 history 불러오기
    setHistory(
      sessionStorage.getItem("login_history")
        ? (sessionStorage.getItem("login_history") as string)
        : "/"
    );
  }, []);
  ...
  const naverLogin = async () => {
    signIn("naver", { callbackUrl: history });
  };
  const kakaoLogin = async () => {
    signIn("kakao", { callbackUrl: history });
  };
      ...
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className="w-[22.5rem] flex flex-col justify-center my-16 lg:my-24 mt-8 lg:mt-16 text-l-2 dark:text-white">
          ...
          <form
            ...
            className="w-full p-5 mb-4 rounded-lg bg-l-e dark:bg-d-3 drop-shadow-default dark:drop-shadow-dark"
          >
            <TextInput
            ...
            <label
              htmlFor="pw"
              className="w-full font-medium flex justify-between items-center ml-px mt-8"
            >
              <span>비밀번호</span>
              <Link
                href="/user/findpw"
          ...
          <div className="w-full h-14 text-sm rounded-lg mb-2.5 gap-2 flex justify-center items-center border border-l-b dark:border-d-6">
            <div
              ...
              className="w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-naver"
            >
              <svg
                className="w-3.5 fill-white"
                viewBox="0 0 24 24"
            ...
            <div
              ...
              onMouseUp={onMouseUp}
              onMouseOut={onMouseOut}
              className="w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-kakao"
            >
              <svg
            ...
            <div
              ...
              onMouseUp={onMouseUp}
              onMouseOut={onMouseOut}
              className="w-8 h-8 rounded-md group relative flex justify-center items-center cursor-pointer bg-black dark:bg-white"
            >
              <svg
            ...
            >
              <svg
                className="w-5 fill-white dark:fill-black"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="w-full h-14 rounded-lg flex justify-center items-center border border-l-b dark:border-d-6">
            <span className="text-l-5 dark:text-d-c mr-3">
              처음 방문하셨나요?
            </span>
            <Link
              href="/user/register"
