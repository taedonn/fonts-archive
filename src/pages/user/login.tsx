                ...
                <div className='w-[360px] flex flex-col justify-center items-start my-[100px] tlg:my-10'>
                    ...
                    <div className='w-full h-[52px] text-sm rounded-lg mb-2 gap-2 flex justify-center items-center border border-theme-7 dark:border-theme-4'>
                        <div onClick={naverLogin} className='w-7 h-7 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-naver'>
                            ...
                            <div className="login-method login-naver w-max absolute z-10 left-1/2 -top-9 text-xs font-medium leading-none px-3 py-1.5 rounded-md hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-naver text-theme-3">네이버로 로그인</div>
                        </div>
                        <div onClick={kakaoLogin} className='w-7 h-7 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-kakao'>
                            ...
                            <div className="login-method login-kakao w-max absolute z-10 left-1/2 -top-9 text-xs font-medium leading-none px-3 py-1.5 rounded-md hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-kakao text-theme-3">카카오로 로그인</div>
                        </div>
                        <div onClick={googleLogin} className='w-7 h-7 rounded-md group relative flex justify-center items-center cursor-pointer bg-theme-10'>
                            ...
                            <div className="login-method login-google w-max absolute z-10 left-1/2 -top-9 text-xs font-medium leading-none px-3 py-1.5 rounded-md hidden group-hover:block tlg:group-hover:hidden group-hover:animate-zoom-in-fontbox bg-theme-10 text-theme-3">구글로 로그인</div>
                        </div>
