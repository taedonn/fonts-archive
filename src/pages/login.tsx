    ...
    return (
        <>
            ...
            <div className='w-[100%] flex flex-col justify-center items-center mt-[60px] tlg:mt-[56px]'>
                <div className='w-[360px] flex flex-col justify-center items-start mt-[100px]'>
                    <h2 className='text-[20px] text-theme-4 dark:text-theme-9 font-medium mb-[12px]'>로그인</h2>
                    <form className='w-[100%] p-[20px] rounded-[8px] text-theme-10 dark:text-theme-9 bg-theme-5 dark:bg-theme-3 drop-shadow-default dark:drop-shadow-dark'>
                        ...
                        <input type='text' id='id' tabIndex={1} placeholder='이메일을 입력해 주세요.' className='w-[100%] text-[14px] mt-[6px] px-[14px] py-[8px] rounded-[8px] border-[2px] border-theme-4 focus:border-theme-yellow dark:border-theme-blue-2 focus:dark:border-theme-blue-1 placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 dark:bg-theme-blue-2'/>
                        <label htmlFor='pw' className='w-[100%] flex flex-row justify-between items-center text-[14px] ml-px mt-[18px]'>
                            <span>비밀번호</span>
                            <Link href="/findpw" className='text-[12px] text-theme-yellow dark:text-theme-blue-1 hover:underline'>비밀번호를 잊으셨나요?</Link>
                        </label>
                        <input type='password' id='pw' tabIndex={2} placeholder='비밀번호를 입력해 주세요.' className='w-[100%] text-[14px] mt-[6px] px-[14px] py-[8px] rounded-[8px] border-[2px] border-theme-4 focus:border-theme-yellow dark:border-theme-blue-2 focus:dark:border-theme-blue-1 placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 dark:bg-theme-blue-2'/>
                        <button className='w-[100%] h-[40px] rounded-[8px] mt-[16px] text-[14px] font-medium text-theme-4 dark:text-theme-blue-2 bg-theme-yellow/80 hover:bg-theme-yellow tlg:hover:bg-theme-yellow/80 dark:bg-theme-blue-1/80 hover:dark:bg-theme-blue-1 tlg:hover:dark:bg-theme-blue-1/80'>로그인</button>
                    </form>
                    <div className='w-[100%] h-[52px] flex flex-row justify-center items-center mt-[16px] text-[14px] rounded-[8px] border border-theme-7 dark:border-theme-4'>
                        ...
                        <Link href="/regist" className='text-theme-yellow dark:text-theme-blue-1 hover:underline'>회원가입하기</Link>
                    </div>
                </div>
            </div>
        </>
