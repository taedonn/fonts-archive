...
const Privacy = ({params}: any) => {
    ...
    return (
        <>
            {/* Head 부분*/}
            <NextSeo 
                title={"개인정보 처리방침 · 폰트 아카이브"}
                description={"개인정보 처리방침 - 폰트 아카이브 · 상업용 무료 한글 폰트 저장소"}
            />
                    ...
                    <div className='w-[45.5rem] tmd:w-full flex flex-col justify-center items-start mt-8 lg:mt-16 mb-24 lg:mb-32'>
                        ...
                        <div className='w-full text-sm flex flex-col lg:flex-row gap-4 lg:gap-0 justify-between mt-6 p-6 lg:p-8 border border-l-5 dark:border-d-c text-l-5 dark:text-d-c'>
                            <div className='w-full lg:w-1/3 flex flex-col gap-4'>
                                <Link href='/privacy#article1' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 1 조 (목적)</Link>
                                <Link href='/privacy#article2' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 2 조 (처리 및 보유 기간)</Link>
                                <Link href='/privacy#article3' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 3 조 (처리하는 항목)</Link>
                                <Link href='/privacy#article4' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 4 조 (제3자 제공)</Link>
                                <Link href='/privacy#article5' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 5 조 (위탁)</Link>
                            </div>
                            <div className='w-full lg:w-1/3 flex flex-col gap-4'>
                                <Link href='/privacy#article6' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 6 조 (파기)</Link>
                                <Link href='/privacy#article7' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 7 조 (권리·의무)</Link>
                                <Link href='/privacy#article8' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 8 조 (안전성 확보)</Link>
                                <Link href='/privacy#article9' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 9 조 (자동 수집 장치)</Link>
                                <Link href='/privacy#article10' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 10 조 (행태 정보)</Link>
                            </div>
                            <div className='w-full lg:w-1/3 flex flex-col gap-4'>
                                <Link href='/privacy#article11' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 11 조 (추가 이용·제공)</Link>
                                <Link href='/privacy#article12' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 12 조 (가명 정보)</Link>
                                <Link href='/privacy#article13' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 13 조 (개인 정보 보호책임자)</Link>
                                <Link href='/privacy#article14' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 14 조 (접수·처리하는 부서)</Link>
                                <Link href='/privacy#article15' className='lg:hover:text-l-2 lg:hover:dark:text-white lg:hover:underline underline-offset-2'>제 15 조 (권익 침해)</Link>
                            </div>
                        </div>
...
전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다.`}
                        ...
                        <div className='relative mt-16 text-lg font-bold text-l-2 dark:text-white'>
                            제 7 조 (정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)
...
폰트 아카이브는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안 프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.`}
                        ...
                        <div className='relative mt-16 text-lg font-bold text-l-2 dark:text-white'>
                            제 9 조 (개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에 관한 사항)
