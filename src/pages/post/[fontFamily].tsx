        ...
        <>
            ...
            <div className="w-[100%] pt-[32px] tmd:pt-[20px]">
                ...
                <div>
                    ...
                    <div className="w-[100%] flex flex-row tlg:flex-col justify-between items-stretch tlg:items-start mb-[20px] tlg:mb-[16px]">
                    ...
                    {/* 카카오 애드핏 상단 띠배너 */}
                    <div className="w-[100%] mb-[80px] tlg:mb-[60px] tmd:mb-[48px]">
...
export async function getServerSideProps(ctx: any) {
    try {
        ...
        const like = session === null
            ? null
            : await FetchUserLikeOnDetail(session.user, font);
