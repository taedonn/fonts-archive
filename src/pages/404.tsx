    ...
    return (
        <>
            <div className="w-full h-full absolute left-0 top-0 flex flex-col justify-center items-center text-center text-l-2 dark:text-white">
                ...
                <div style={{fontFamily: "Intel One Mono"}} className="w-[22.5rem] h-16 mt-4 flex justify-center items-center rounded-lg text-sm bg-h-1/20 dark:bg-f-8/20 border border-dashed border-h-1 dark:border-f-8">404: Page Not Found</div>
