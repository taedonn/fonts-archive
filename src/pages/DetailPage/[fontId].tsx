            ...
            <div className="w-[100%] pt-[20px] tmd:pt-[16px]">
                ...
                <div>
                    ...
                    <div className="w-[100%] flex flex-row tlg:flex-col justify-between items-start">
                        <table className="tlg:w-[100%] tlg:mb-[16px] text-left rounded-[12px] border border-theme-7 dark:border-theme-5">
                            ...
                            <tbody className="text-[13px] leading-tight text-theme-5 dark:text-theme-8 fill-theme-5 dark:fill-theme-7 text-left font-normal">
                                <tr className="relative">
                                    <td className="h-[72px] flex flex-col justify-center items-center">
                        ...
                        <div className="w-[calc(100%-690px)] tlg:w-[100%] h-[705px] tlg:h-[auto] mb-[32px] tlg:mb-[16px] border border-theme-7 dark:border-theme-5">
                            ...
                            <div className="license-wrap w-[100%] h-[648px] tlg:h-[auto] overflow-hidden overflow-y-auto px-[28px] tlg:px-[24px] tmd:px-[20px] py-[12px] tlg:py-[16px]">
