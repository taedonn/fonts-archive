    ...
    return (
        <>
            ...
            <div className="w-[100%] mt-[60px] tlg:mt-[56px] p-[20px] tlg:p-[16px] tmd:p-[12px] py-[24px] tlg:py-[20px] tmd:py-[16px]">
                ...
                <div className="mb-[20px] tlg:mb-[16px] tmd:mb-[12px]">
                ...
                {/* Google AdSense */}
                {/* <div className="w-[100%] h-[160px] flex flex-row justify-center items-center border border-theme-7 dark:border-theme-5">
