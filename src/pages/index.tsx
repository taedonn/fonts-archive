            ...
            <div className='interface w-[100%] h-[60px] tlg:h-[56px] px-[20px] tlg:px-[16px] tmd:px-[12px] fixed right-0 top-0 z-10 flex flex-row justify-between items-center backdrop-blur bg-theme-10/80 dark:bg-theme-2/80 border-b border-theme-9 dark:border-theme-4'>
                <div className="tlg:w-[100%] flex flex-row justify-start items-center">
                    ...
                    <div className="tlg:w-[calc(100%-56px)] relative group">
                        <input onChange={handleTextChange} type='text' placeholder='원하는 문구를 적어보세요...' className="w-[400px] txl:w-[260px] tlg:w-[100%] text-[14px] tlg:text-[12px] text-normal dark:text-theme-8 leading-none border rounded-full dark:border-theme-4 px-[20px] tlg:px-[16px] py-[10px] tlg:py-[8px] pl-[52px] tlg:pl-[38px] bg-transparent group-hover:dark:bg-theme-3/40 tlg:group-hover:bg-transparent focus:dark:bg-theme-3/40 tlg:focus:bg-transparent"/>
                ...
                <div className='w-content flex flex-row justify-start items-center'>
                    <div className="flex flex-row justify-end items-center tlg:hidden">
                        <div className='w-content relative flex flex-row justify-start items-center'>
                            ...
                            <label ref={refLangSelect} htmlFor='select-lang' className="h-[32px] tlg:h-[30px] tmd:h-[28px] relative flex flex-row justify-center items-center text-[14px] dark:text-theme-8 leading-none tracking-normal px-[20px] tlg:px-[16px] tmd:px-[12px] border dark:border-theme-5 rounded-full cursor-pointer fill-theme-8 hover:dark:bg-theme-blue-2 hover:dark:border-theme-blue-1 hover:dark:text-theme-9 hover:fill-theme-9 hover:drop-shadow-default hover:dark:drop-shadow-dark">
                            ...
                            <div ref={refLangOption} id="option-lang" className='option w-[128px] tlg:w-[108px] tmd:w-[92px] absolute z-2 left-[50%] top-[40px] tlg:top-[36px] tmd:top-[34px] translate-x-[-50%] border dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] tlg:px-[14px] tmd:px-[12px] py-[20px] tmd:py-[14px] tlg:py-[16px] dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    <label htmlFor='option-lang-all'>
                                        <svg className='w-[18px] tlg:w-[14px] mr-[10px] tlg:mr-[8px] cursor-pointer fill-theme-blue-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/><path d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.235.235 0 0 1 .02-.022z"/></svg>
                                        <svg className='w-[18px] tlg:w-[14px] mr-[10px] tlg:mr-[8px] cursor-pointer fill-theme-blue-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/></svg>
                                    </label>
                                    <span className="text-[14px] tlg:text-[12px] dark:text-theme-9 leading-tight tlg:pb-px">전체</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] dark:text-theme-9 leading-tight tlg:pb-px">한국어</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] dark:text-theme-9 leading-tight tlg:pb-px">영어</span>
                                </div>
                            </div>
                        </div>
                        <div className='w-content relative flex flex-row justify-start items-center ml-[8px]'>
                            ...
                            <div ref={refTypeOption} id="option-type" className='option w-[128px] tlg:w-[108px] tmd:w-[92px] absolute z-2 left-[50%] top-[40px] tlg:top-[36px] tmd:top-[34px] translate-x-[-50%] border border-theme-5 dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] tlg:px-[14px] tmd:px-[12px] py-[20px] tmd:py-[14px] tlg:py-[16px] bg-theme-5 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">전체</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">고딕</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">명조</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">손글씨</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">장식체</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">픽셀체</span>
                                </div>
                            </div>
                        </div>
                        <div className='w-content relative flex flex-row justify-start items-center ml-[8px]'>
                            <input type='checkbox' id='select-sort' onChange={handleSortChange} className="select hidden"/>
                            <label ref={refSortSelect} htmlFor='select-sort' className="h-[32px] tlg:h-[30px] tmd:h-[28px] relative flex flex-row justify-center items-center text-[14px] text-theme-5 dark:text-theme-8 leading-none px-[20px] tlg:px-[16px] border border-theme-8 dark:border-theme-5 rounded-full cursor-pointer fill-theme-5 dark:fill-theme-8 hover:bg-theme-10 hover:dark:bg-theme-blue-2 hover:border-theme-yellow hover:dark:border-theme-blue-1 hover:dark:text-theme-9 hover:fill-theme-5 hover:dark:fill-theme-9 hover:drop-shadow-default hover:dark:drop-shadow-dark">
                                <div className='w-[100%] h-[100%] absolute z-10'></div>
                                <button className="w-[100%] h-[100%] flex flex-row justify-center items-center text-inherit leading-none text-[14px] tlg:text-[12px] tmd:text-[10px] pt-px">
                            ...
                            <div ref={refSortOption} id="option-sort" className='option w-[114px] tlg:w-[96px] tmd:w-[88px] absolute z-2 left-[50%] top-[40px] tlg:top-[36px] tmd:top-[34px] translate-x-[-50%] border border-theme-5 dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] tlg:px-[14px] tmd:px-[12px] py-[22px] tlg:py-[16px] tmd:py-[14px] bg-theme-5 dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">조회순</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">최신순</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px text-theme-9/80 dark:text-theme-9 leading-tight">이름순</span>
                                </div>
                            </div>
                        </div>
                        <div className='w-px h-[20px] tlg:h-[16px] rounded-full mx-[10px] tlg:mx-[8px] dark:bg-theme-4'></div>
                    </div>
                    <div className="w-content relative tlg:hidden">
                        <input onChange={handleSearch} type="text" placeholder="폰트, 회사명을 검색해 보세요..." className="w-[280px] txl:w-[200px] text-[14px] text-normal placeholder-theme-5 text-theme-5 dark:text-theme-8 leading-none border rounded-full border-theme-8 dark:border-theme-4 px-[20px] py-[10px] pl-[44px] bg-transparent group-hover:dark:bg-theme-3/40 tlg:group-hover:bg-transparent focus:dark:bg-theme-3/40"/>
                    ...
                    <Link href="https://github.com/taedonn/fonts-archive" target="_blank" className="w-[32px] h-[32px] flex flex-row justify-center items-center">
                        <svg className="w-[22px] fill-theme-3/80 dark:fill-theme-9/80 hover:fill-theme-3 hover:dark:fill-theme-9 tlg:hover:fill-theme-9/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg>
                    </Link>
                </div>
            </div>
