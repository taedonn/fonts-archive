                ...
                <div className='w-content flex flex-row justify-start items-center'>
                    <div className="flex flex-row justify-end items-center tlg:hidden">
                        ...
                        <div className='w-content relative flex flex-row justify-start items-center ml-[8px]'>
                            ...
                            <div ref={refTypeOption} id="option-type" className='option w-[128px] tlg:w-[108px] tmd:w-[92px] absolute z-2 left-[50%] top-[40px] tlg:top-[36px] tmd:top-[34px] translate-x-[-50%] border dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] tlg:px-[14px] tmd:px-[12px] py-[20px] tmd:py-[14px] tlg:py-[16px] dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">전체</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">고딕</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">명조</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">손글씨</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">장식체</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">픽셀체</span>
                                </div>
                            </div>
                        </div>
                        <div className='w-content relative flex flex-row justify-start items-center ml-[8px]'>
                            ...
                            <div ref={refSortOption} id="option-sort" className='option w-[114px] tlg:w-[96px] tmd:w-[88px] absolute z-2 left-[50%] top-[40px] tlg:top-[36px] tmd:top-[34px] translate-x-[-50%] border dark:border-theme-blue-1 rounded-[12px] flex flex-col justify-start items-start px-[16px] tlg:px-[14px] tmd:px-[12px] py-[22px] tlg:py-[16px] tmd:py-[14px] dark:bg-theme-blue-2 drop-shadow-default dark:drop-shadow-dark'>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">조회순</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center mb-[16px] tlg:mb-[10px]'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">최신순</span>
                                </div>
                                ...
                                <div className='flex flex-row justify-start items-center'>
                                    ...
                                    <span className="text-[14px] tlg:text-[12px] tlg:pb-px dark:text-theme-9 leading-tight">이름순</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-content relative tlg:hidden">
                        <input onChange={handleSearch} type="text" placeholder="폰트, 회사명을 검색해 보세요..." className="w-[280px] txl:w-[200px] text-[14px] text-normal text-theme-6 dark:text-theme-8 leading-none border rounded-full border-theme-8 dark:border-theme-4 px-[20px] py-[10px] pl-[44px] bg-transparent group-hover:dark:bg-theme-3/40 tlg:group-hover:bg-transparent focus:dark:bg-theme-3/40"/>
                        <svg className="w-[12px] absolute left-[20px] top-[50%] translate-y-[-50%] fill-theme-7 dark:fill-theme-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/></svg>
                    </div>
