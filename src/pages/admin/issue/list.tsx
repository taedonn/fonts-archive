                                        ...
                                        ? <>
                                            {
                                                list.map((issue: any) => {
                                                    return (
                                                        <div key={issue.issue_id} className='px-6 py-4 relative rounded-lg bg-l-f dark:bg-d-3'>
                                                            <div className="flex tlg:flex-col lg:items-center gap-2 mb-2">
                                                                <Link href={`/admin/issue/${issue.issue_id}`} className="block text-h-1 dark:text-f-8 lg:hover:underline">{issue.issue_title}</Link>
