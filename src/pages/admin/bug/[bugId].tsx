            ...
            <div className='w-full flex flex-col justify-center items-center'>
                <div className='relative max-w-[720px] w-full flex flex-col justify-center items-start my-[100px] tlg:my-10'>
                    ...
                    <div className='w-full p-5 rounded-lg text-sm text-theme-10 dark:text-theme-9 bg-theme-5 dark:bg-theme-3 drop-shadow-default dark:drop-shadow-dark'>
                        ...
                        <input id="title" defaultValue={issue.issue_title} type="text" disabled className='w-full border-theme-6 dark:border-theme-4 text-xs mt-2 px-2.5 py-1.5 rounded-lg border-2 bg-theme-4 dark:bg-theme-2 text-theme-10 dark:text-theme-9 cursor-text'/>
                        <label htmlFor="email" className="block mt-5">이메일</label>
                        <input id="email" defaultValue={issue.issue_email} type="text" disabled className='w-full border-theme-6 dark:border-theme-4 text-xs mt-2 px-2.5 py-1.5 rounded-lg border-2 bg-theme-4 dark:bg-theme-2 text-theme-10 dark:text-theme-9 cursor-text'/>
                        ...
                        <div className="mt-5">해결 여부</div>
                        <div className="w-max flex items-center text-xs mt-3 px-5 py-2 rounded-lg bg-theme-4 dark:bg-theme-blue-2">
                            <div className={`mr-1`}>해결 중</div>
                            <Switch
                                checked={issueClosed}
                                onChange={handleToggleChange}
                                size="small"
                            />
                            <div className={`${issueClosed ? "text-theme-green" : ""} ml-1.5`}>해결 됨</div>
                        </div>
