                ...
                <div className='max-w-[720px] w-full flex flex-col justify-center items-start my-[100px] tlg:my-[40px]'>
                    ...
                    <div className='w-full p-[20px] rounded-[8px] text-theme-10 dark:text-theme-9 bg-theme-5 dark:bg-theme-3 drop-shadow-default dark:drop-shadow-dark'>
                        <div className="w-max relative">
                            ...
                            <div ref={refSearchResult} style={focus ? {display: "block"} : {display: "none"}} className="edit-font-search w-full h-[180px] overflow-y-auto absolute z-10 bottom-[-6px] translate-y-[100%] rounded-[8px] py-[10px] bg-theme-4 dark:bg-theme-blue-2">
                                {
                                    data.fonts && isSuccess && !isLoading && !isRefetching
                                    ? data.fonts.length !== 0
                                        ? data.fonts.map((font: any) => {
                                            return (
                                                <div key={font.code} className="group relative w-full h-[36px] px-[12px] flex items-center bg-transparent hover:bg-theme-yellow hover:dark:bg-theme-blue-1 text-[12px] cursor-pointer">
                        ...
                        <div className="w-full h-px my-[16px] bg-theme-8/80 dark:bg-theme-7/80"></div>
                        <div className="text-[14px] flex flex-col">
                            <label htmlFor="font-code">폰트 번호</label>
                            <input type="text" defaultValue={defaultFont !== null ? defaultFont.code : ""} disabled id="font-code" placeholder="폰트 번호" className='w-full border-theme-6 dark:border-theme-4 text-[12px] mt-[8px] px-[14px] py-[6px] rounded-[8px] border-[2px] placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 autofill:bg-theme-4 dark:bg-theme-2 autofill:dark:bg-theme-blue-2'/>
...
`@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/NanumSquare/NanumSquare.woff2') format('woff2'),
            ...
            url('https://cdn.jsdelivr.net/gh/fonts-archive/NanumSquare/NanumSquare.ttf') format('truetype');
                                ...
                                className={`font-edit-textarea w-full h-[196px] resize-none ${fontCdnFontFaceAlert ? 'border-theme-red focus:border-theme-red' : 'border-theme-4 focus:border-theme-yellow dark:border-theme-blue-2 focus:dark:border-theme-blue-1' } text-[12px] mt-[8px] px-[14px] py-[6px] rounded-[8px] border-[2px] placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 dark:bg-theme-blue-2 autofill:bg-theme-4 autofill:dark:bg-theme-blue-2`}>
                            </textarea>
                            {
...
네이버 글꼴 라이선스 전문을 포함하기 어려울 경우 출처 표기를 권장합니다. 예) 이 페이지에는 네이버에서 제공한 나눔 고딕 글꼴이 적용되어 있습니다.`} 
                                className={`font-edit-textarea w-full h-[196px] resize-none ${fontLicenseTextAlert ? 'border-theme-red focus:border-theme-red' : 'border-theme-4 focus:border-theme-yellow dark:border-theme-blue-2 focus:dark:border-theme-blue-1' } text-[12px] mt-[8px] px-[14px] py-[6px] rounded-[8px] border-[2px] placeholder-theme-7 dark:placeholder-theme-6 bg-theme-4 dark:bg-theme-blue-2 autofill:bg-theme-4 autofill:dark:bg-theme-blue-2`}>
                            </textarea>
                            {
                        ...
                        <button onClick={editBtnClick} className="w-full h-[34px] rounded-[8px] mt-[20px] font-medium text-[12px] text-theme-5 dark:text-theme-3 bg-theme-yellow/80 hover:bg-theme-yellow dark:bg-theme-blue-1/80 hover:dark:bg-theme-blue-1 tlg:hover:dark:bg-theme-blue-1">
                            {
                                editBtnLoading
