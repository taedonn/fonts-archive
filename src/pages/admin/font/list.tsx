                ...
                <form onSubmit={e => e.preventDefault()} className='w-full px-4 flex flex-col justify-center items-center text-l-2 dark:text-white'>
                    <div className='w-full md:w-[45rem] flex flex-col justify-center my-16 lg:my-24 mt-8 lg:mt-16'>
                        ...
                        <div className='flex items-center mb-10'>
                            <SearchInput id="search" placeholder="폰트 검색" value={search} color="light"/>
                                        ...
                                        ? <>
                                            {
                                                fonts.map((font: any) => {
                                                    return (
                                                        <div key={font.code} className='px-6 py-4 relative rounded-lg bg-l-f dark:bg-d-3'>
                                                            <div className="flex tlg:flex-col lg:items-center gap-2 mb-2">
                                                                <Link href={`/admin/font/edit?code=${font.code}`} className="block text-h-1 dark:text-f-8 lg:hover:underline">{font.name}</Link>
