    ...
    return (
        <>
            <div className="w-full h-full absolute left-0 top-0 flex flex-col justify-center items-center text-center text-theme-3 dark:text-theme-9">
                ...
                <div style={{fontFamily: "Intel One Mono"}} className="w-[340px] h-[60px] mt-4 flex justify-center items-center rounded-lg text-sm text-theme-3 dark:text-theme-9 bg-theme-red/20 dark:bg-theme-blue-1/20 border border-dashed border-theme-red dark:border-theme-blue-1">500: Internal Server Error</div>
